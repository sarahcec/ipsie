...
_ The current SL1 profile explictly requires pre-registration, does not support dynamic registration.  However, it's unclear to me at this time how to enforce a trust agreement as part of pre-registration. -dhs_
